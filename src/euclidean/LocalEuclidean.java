 ...
 */
public class LocalEuclidean implements LocalSimilarityFunction {
	 ...
	 * Constructor.
	 */
	public LocalEuclidean(double interval) {
		_interval = interval;
	}
	...
	public double compute(Object o1, Object o2) throws jcolibri.exception.NoApplicableSimilarityFunctionException{
		...
		double result = 0, distTmp = 0;
		
		distTmp = (v1 - v2);
		//mesma coisa que elevar ao quadrado
        distTmp = Math.sqrt(distTmp * distTmp); //power of 2
//preciso colocar o intervalo para normalizar
        
		return 1 - distTmp/_interval;
	}
