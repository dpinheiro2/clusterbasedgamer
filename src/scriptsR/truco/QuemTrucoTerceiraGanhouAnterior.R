...
sqlK<- ("select MAX(clusterQuemTrucoTerceiraGanhouAnterior) from maos;")
...
excluiLabelCluster("clusterQuemTrucoTerceiraGanhouAnterior")



#aqui realiza o insert
realizaInsertClusteringPertencente(resultadokmeans,"clusterQuemTrucoTerceiraGanhouAnterior")
...
sql <-sprintf("INSERT INTO centroidesQuemTrucoTerceiraGanhouAnterior(grupo, quemTruco, quemRetruco, quemValeQuatro,numerok, cartaAltaRoboClustering, cartaMediaRoboClustering, cartaBaixaRoboClustering) 
...
excluirConteudoTabela("centroidesQuemTrucoTerceiraGanhouAnterior")
