...
sql <- ("select quemTrucoCluster, quemRetrucoCluster, quemValeQuatroCluster, cartaAltaRoboClustering, cartaMediaRoboClustering, cartaBaixaRoboClustering, id from maos where utilTruco =1 and jogadorMao = 1;")
...
sqlK<- ("select MAX(clusterQuemTrucoPrimeiraMao) from maos;")
...
excluiLabelCluster("clusterQuemTrucoPrimeiraMao")



#aqui realiza o insert
realizaInsertClusteringPertencente(resultadokmeans,"clusterQuemTrucoPrimeiraMao")
...
sql <-sprintf("INSERT INTO centroidesQuemTrucoPrimeiraMao(grupo, quemTruco, quemRetruco, quemValeQuatro,numerok, cartaAltaRoboClustering, cartaMediaRoboClustering, cartaBaixaRoboClustering) 
...
excluirConteudoTabela("centroidesQuemTrucoPrimeiraMao")
